...
```text
Current implementation test design.
Historical plan-stage items were reconciled with the active center-frame workflow.
```
...
- manifest.json is generated for evidence-only runs.
